 ...
 */
class getTriangleRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TriangleRepository' shared autowired service.
     *
     * @return \App\Repository\TriangleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TriangleRepository.php';

        return $container->privates['App\\Repository\\TriangleRepository'] = new \App\Repository\TriangleRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
